...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './anexo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANEXO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANEXO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANEXO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANEXO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANEXO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANEXO actions', async () => {
      const expectedActions = [
        {
