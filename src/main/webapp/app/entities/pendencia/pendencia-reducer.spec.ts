...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pendencia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PENDENCIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PENDENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PENDENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PENDENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PENDENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PENDENCIA actions', async () => {
      const expectedActions = [
        {
