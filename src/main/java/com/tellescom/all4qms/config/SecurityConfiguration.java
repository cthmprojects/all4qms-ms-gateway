...
import com.tellescom.all4qms.security.jwt.JWTFilter;
import com.tellescom.all4qms.security.jwt.TokenProvider;
import com.tellescom.all4qms.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/api/admin/users-by-role").permitAll()
