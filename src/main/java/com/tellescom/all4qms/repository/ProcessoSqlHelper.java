...
public class ProcessoSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("setor", table, columnPrefix + "_setor"));
        columns.add(Column.aliased("responsavel", table, columnPrefix + "_responsavel"));
        columns.add(Column.aliased("setor_responsavel", table, columnPrefix + "_setor_responsavel"));
