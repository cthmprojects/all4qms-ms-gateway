...
public class PendenciaSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("lida_em", table, columnPrefix + "_lida_em"));
        ...
        columns.add(Column.aliased("responsavel_id", table, columnPrefix + "_responsavel_id"));
