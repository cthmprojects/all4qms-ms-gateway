...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tellescom.all4qms.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tellescom.all4qms.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
